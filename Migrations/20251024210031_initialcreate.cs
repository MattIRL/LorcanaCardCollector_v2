    ...
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "AIR-003", "King Stefan - New Father", 0, true, 2, "Archazilia's Island" },
                    { "ARI-001", "Rhino - Motivational Speaker", 10, true, 1, "Archazia's Island" },
                    { "ARI-002", "Perdita - Playful Mother", 9, false, 1, "Archazia's Island" }
                });
        }
